    ...
    >
      <div className="flex items-center justify-between whitespace-nowrap">
        <div className="flex items-center gap-3">
          ...
          <h2 className="text-white text-lg font-bold tracking-wider">Mohamad<span className="text-primary">Arif</span></h2>
        </div>
        ...
        <div className="hidden md:flex flex-1 justify-end items-center gap-8">
          ...
          <a href="#contact">
            <button className="flex items-center justify-center rounded-lg h-10 px-5 bg-primary/90 text-white text-sm font-bold hover:bg-primary transition-all glow-violet hover:scale-105 active:scale-95">
              Get In Touch
            </button>
          </a>
        </div>
