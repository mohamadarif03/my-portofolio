                ...
                <div className="lg:col-span-2 flex flex-col gap-6">
                    <Reveal delay={0.4} width="100%">
                        <div className="glassmorphism rounded-2xl p-8 flex flex-col gap-6 h-full justify-center">
                            <a href="mailto:mohamadarif5392@gmail.com" className="flex items-center gap-4 group p-3 rounded-lg hover:bg-white/5 transition-all">
                                ...
                                <div>
                                    ...
                                    <p className="text-white font-medium group-hover:text-primary transition-colors">mohamadarif5392@gmail.com</p>
                                </div>
                            </a>

                            <a href="https://wa.me/6285889561705" target="_blank" rel="noopener noreferrer" className="flex items-center gap-4 group p-3 rounded-lg hover:bg-white/5 transition-all">
                                ...
                                <div>
                                    ...
                                    <p className="text-white font-medium group-hover:text-green-500 transition-colors">+62 858-8956-1705</p>
                                </div>
                            </a>

                            <a href="https://www.linkedin.com/in/mohamad-arif-68402627a/" target="_blank" rel="noopener noreferrer" className="flex items-center gap-4 group p-3 rounded-lg hover:bg-white/5 transition-all">
                                ...
                                <div>
                                    ...
                                    <p className="text-white font-medium group-hover:text-secondary transition-colors">Mohamad Arif</p>
                                </div>
                            </a>

                            <a href="https://instagram.com/mhmdarif346" target="_blank" rel="noopener noreferrer" className="flex items-center gap-4 group p-3 rounded-lg hover:bg-white/5 transition-all">
                                ...
                                <div>
                                    ...
                                    <p className="text-white font-medium group-hover:text-pink-500 transition-colors">@mhmdarif346</p>
                                </div>
                            </a>
